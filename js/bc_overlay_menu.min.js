...
c.forEach((e)=>{1==parseFloat(e.querySelector("button").getAttribute("data-scroll"))&&(t=!0),e.addEventListener("click",function(){g()})}),window.location.href.includes("brickspreview")||document.addEventListener("keydown",function(e){d&&"Escape"===e.key&&g(),t&&document.querySelector("html").hasAttribute("bc-core-burguer--body-toggled")&&document.querySelector("html").removeAttribute("bc-core-burguer--body-toggled")})})}
