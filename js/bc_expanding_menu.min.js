...
function p(){manipularTabIndex(o);if(d.length>0){d.forEach((e)=>{let n=e.querySelector("button").classList,r="";n.length>0&&(r=`${n[0]}--opened`);l?(e.querySelector("button").classList.remove(r),e.querySelector("button").setAttribute("aria-expanded","false"),(o.style.pointerEvents="none"),t.removeAttribute("data-open","bc-expanding-menu--opened"),c.reverse()):(e.querySelector("button").classList.add(r),e.querySelector("button").setAttribute("aria-expanded","true"),(o.style.pointerEvents="all"),t.setAttribute("data-open","bc-expanding-menu--opened"),c.play())})}
