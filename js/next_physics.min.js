...
switch(shape){case "rectangle":var rectangle=Bodies.rectangle(parseFloat(horizontalData[index]),parseFloat(verticalData[index]),parseFloat(widthData[index]),parseFloat(heightData[index]),{isStatic:varStatic,restitution:parseFloat(restitutionData[index]),friction:parseFloat(frictionData[index]),frictionAir:parseFloat(frictionAirData[index]),density:parseFloat(densityData[index]),chamfer:{radius:parseFloat(borderRadiusData[index])},render:{visible:!0,sprite:{texture:varImageUrl,xScale:parseFloat(imageScale[index]),yScale:parseFloat(imageScale[index])},fillStyle:fillData[index],lineWidth:parseFloat(strokeWidthData[index]),strokeStyle:strokeColorData[index],},});World.add(engine.world,[rectangle]);break;case "circle":var circle=Bodies.circle(parseFloat(horizontalData[index]),parseFloat(verticalData[index]),parseFloat(radiusCircleData[index]),{isStatic:varStatic,restitution:parseFloat(restitutionData[index]),friction:parseFloat(frictionData[index]),frictionAir:parseFloat(frictionAirData[index]),density:parseFloat(densityData[index]),chamfer:{radius:parseFloat(borderRadiusData[index])},render:{visible:!0,sprite:{texture:varImageUrl,xScale:parseFloat(imageScale[index]),yScale:parseFloat(imageScale[index])},fillStyle:fillData[index],lineWidth:parseFloat(strokeWidthData[index]),strokeStyle:strokeColorData[index],},});World.add(engine.world,[circle]);break;case "polygon":var polygon=Bodies.polygon(parseFloat(horizontalData[index]),parseFloat(verticalData[index]),parseFloat(sidesData[index]),parseFloat(radiusPolygonData[index]),{isStatic:varStatic,restitution:parseFloat(restitutionData[index]),friction:parseFloat(frictionData[index]),frictionAir:parseFloat(frictionAirData[index]),density:parseFloat(densityData[index]),chamfer:{radius:parseFloat(borderRadiusData[index])},render:{visible:!0,sprite:{texture:varImageUrl,xScale:parseFloat(imageScale[index]),yScale:parseFloat(imageScale[index])},fillStyle:fillData[index],lineWidth:parseFloat(strokeWidthData[index]),strokeStyle:strokeColorData[index],},});World.add(engine.world,[polygon]);break}});const mouseControl=MouseConstraint.create(engine,{element:nextPhysics,constraint:{stiffness:parseFloat(varStiffness),render:{visible:!1}}});mouseControl.mouse.element.removeEventListener("mousewheel",mouseControl.mouse.mousewheel);mouseControl.mouse.element.removeEventListener("DOMMouseScroll",mouseControl.mouse.mousewheel);mouseControl.mouse.element.removeEventListener('touchstart',mouseControl.mouse.mousedown);mouseControl.mouse.element.removeEventListener('touchmove',mouseControl.mouse.mousemove);mouseControl.mouse.element.removeEventListener('touchend',mouseControl.mouse.mouseup);mouseControl.mouse.element.addEventListener('touchstart',mouseControl.mouse.mousedown,{passive:!0});mouseControl.mouse.element.addEventListener('touchmove',(e)=>{if(mouseControl.body){mouseControl.mouse.mousemove(e)}});mouseControl.mouse.element.addEventListener('touchend',(e)=>{if(mouseControl.body){mouseControl.mouse.mouseup(e)}});World.add(engine.world,[mouseControl]);const wallOptions={isStatic:!0,render:{visible:wallVisible,fillStyle:elementStyles.getPropertyValue("--fill-wall").trim()}};var borderWidth=parseFloat(nextPhysics.getAttribute("data-wall-width"));if(enableTopWall){World.add(engine.world,[Bodies.rectangle(nextPhysics.clientWidth/2,0,nextPhysics.clientWidth,borderWidth,wallOptions)])}
