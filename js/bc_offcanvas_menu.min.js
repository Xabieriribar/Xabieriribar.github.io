...
document.querySelectorAll(".bc-offcanvas-menu").forEach((o)=>{let toggleBody=o.getAttribute("data-customtoggle-lock-body-scrolling")==="1";var r=o.getAttribute("data-open-builder");let n=!1;var a=o.querySelector(".bc-offcanvas-menu__items-wrapper"),c=o.getAttribute("data-duration"),u=o.getAttribute("data-easing"),i=o.getAttribute("data-type");let l=gsap.timeline({paused:!0,onStart:function(){o.setAttribute("data-hide-content","false")},onReverseComplete:function(){a.style.clipPath=s;o.setAttribute("data-hide-content","true")},});if((t(a),"fromTop"==i))
